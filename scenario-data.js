    ...
    "SC-C4-08": {
      ...
      variants: {
        ...
        true: {
          ...
          // 握手の順序（protagonist_policy §5-1・つる裁定 2026-08-02 で改訂）:
          // ショウ壊さない一撃 → ノリ哲学の手渡し → レントン手を読む・読めない →
          // レントンがリコへ渡す → リコが手を差し出す（契約と握手を一人で担う） → レントンが意味を置く
          lines: [
            ...
            line("レントン", "リコさん。……この人の手、なんも読めん。読めん相手に先に触るんは、決める人の役目やと思う"),
            stage("リコが、一歩前に出る。決めるのは、いつでもこの人の役目だった"),
            line("リコ", "リリースノートの最終行、連名にする。止めることと、実装すること。両方の責任、うちも半分持つ。——GADGET と、RAML で"),
            stage("リコが手を差し出す。ケイスケが、少し遅れて、握り返す"),
            line("レントン", "行って、帰ってくる。……それが、握手なんよ、たぶん"),
            stage("握手のあと、リコが自分の手を一度握って、開く"),

  ...
  const SCENES = {
    "SC-01": {
      ...
      choice: choice("CH-01-A", "リリースノート最終行", [
        ...
        option("A2", "これは支配ではなく解放です", [effect("freedom_insight", 3), effect("gadget_analysis", 2)], [
          line("ケイスケ", "『支配』って書くやつは、支配する気があるやつだ。俺は違う。……違うぞ？", "keisuke", "serious"),
    ...
    "SC-03": {
      ...
      lines: [
        ...
        stage("カットイン——レントンの手元。「予約が消えた人」の肩を支えている手。事件を最初に身体で受け取っている画"),
      ...
      after: [
        stage("空撮カット。現場の街並みは、妙に静かで、妙に整っている"),
    ...
    "SC-08": {
      ...
      lines: [
        ...
        line("ケイスケ", "かわいいだろ。なりたい姿で、なりたいように生きてる。——それが俺の言う『自由』だ。名刺代わりにはなったかな", "keisuke", "neutral")
      ],
      battle: "BT-03"
    },
    "SC-09": {
      ...
      variants: {
        bad: {
          ...
          body: "夜明け前の街。AUTONOMYの一部は停止しきれず、市中に残存している。\n街頭ビジョンに、匿名の書き込みが流れ続ける——「#GADGETは正しかった」「あの窓口の行列に、戻りたい人いる？」\nRAMLの四人は、無言でそれを見上げる。リコは何も言わない。\nノリ「……審判のいない試合が、始まってます」"
        },
        normal: {
          id: "SC-09b", title: "対処完了",
          body: "窓口に人が戻り、連絡網が再配信され、掲示板の「最適化済」が剥がされていく。\n司令室。リコの端末に、GADGET署名の着信——リコは、見ずに受信拒否を設定する。\n報告書ウィンドウが事務的に流れる。「案件: AUTONOMY事件／対処: 完了／市民生活への影響: 軽微。以上」\nリコ「……以上。解散」\n誰も何も言わない。"
        },
        true: {
          id: "SC-09c", title: "そのツール、悪くなかったよ",
          body: "市庁地下。安全停止したAUTONOMY。機能は破壊されず、封印保存の処理が走る。\nリコ「壊さない。……いつか正しく使える日が来たら、そのとき考える」\n——回想。撤退間際の、一言だけの会話。\nリコ「……そのツール、悪くなかったよ。審判がいれば、だけど」\nケイスケ「Ver.1.0で会おう」\n司令室。ふと、私用端末の通知——保育園連絡網、復旧。\nリコ「……直ってる。前より、便利になってる」\n配信一覧は以前より整理され、既読確認まで付いている。リコ、報告書の「被害」の欄で手が止まる。\nリコ「（小さく）……『被害』とだけは、書けないか」\nカーソルが点滅したまま。"
        }
      }
    },
    "SC-10": {
      ...
      lines: [
        ...
        stage("ショウだけが最後にフレームに残る。街灯に伸びた影が——1カットだけ、別のシルエットに見える。本人は気づかない", "ci_sho_shadow_01"),
    ...
    "SC-C2-01": {
      ...
      after: [
        line("ケイスケ", "俺は、そこまでやれと言ってない", "keisuke", "serious"),
    ...
    "SC-C2-09": {
      ...
      variants: {
        bad: {
          ...
          body: "夜明け前。EX亜種の配布数カウンタが、ゼロから再び回り出す。\n賛同者コミュニティの投稿が流れる——「EXのほうが使いやすい」「本家は制約が多すぎ」「EX-proができたらしい」\nノリ「……誰も、あの一行の話をしてません。誰も」\n遠景。撤退したケイスケの小さな背中。呟きだけが字幕で残る。\nケイスケ「……全部、俺のルールで統一するしか、ないのか」"
        },
        normal: {
          id: "SC-C2-09b", title: "主語のない報告書",
          body: "EXは市中から取り除かれた。市民の端末から「決定済み」が消え、確認通知が戻ってくる。\n司令室。リコ、報告書の主語欄で手を止める。「GADGET製」と打ちかけて——消して、定型文を選ぶ。\n「案件: DELEGATE-EX事件／原因: GADGET系ツール／対処: 完了。以上」\nリコ「……以上。解散」\nラボのカット。EXの消滅を確認するケイスケ。\nケイスケ「……まとめて悪者、か。楽でいいな、そっちは」"
        },
        true: {
          id: "SC-C2-09c", title: "コメントの書き方",
          body: "EXの処遇が確定する。本家DELEGATEの画面に「提供条件: 意思確認（削除不可）」の一行が追記されていく。\n撤退間際のケイスケと、短い会話が成立する。\nノリ「コメントの書き方が、違いましたね。本家は——読む人がいる前提で、書いてあった」\nケイスケ、一瞬だけ「わかる奴がいた」という顔をする。すぐ隠す。\nケイスケ「……お前、diffを最後まで読んだのか。物好きだな」\nノリ「読みかけの本は、嫌いなので」\n司令室。リコの報告書。主語が「GADGET（本家DELEGATE）」と「DELEGATE-EX（無断フォーク）」に書き分けられている。\nリコ「……長くなっちゃった、報告書。でも、これが正確」"
        }
      }
    },
    "SC-C2-10": {
      ...
      lines: [
        ...
        stage("一覧の中に一件だけ、見慣れない代行の行が混じっている。1カットのみ。誰も言及しない"),
    ...
    "SC-C3-01": {
      ...
      lines: [
        stage("夜。ラボの隅に、真新しい椅子が一脚——布も掛けられず、まだ一度も座られていない。モニタに「AUTONOMY Ver.1.0-rc — 試験地区 稼働中」"),
      ...
      choice: choice("CH-C3-01-A", "神輿の夜", [
        ...
        option("A3", "椅子に布を掛けて、工具の山に戻る", [effect("ai_mastery", 3), effect("freedom_insight", 2)], [
          ...
          line("ケイスケ", "……据わりが悪い。俺の仕事場は、こっちだ", "keisuke", "neutral")
        ])
      ]),
      after: [
    ...
    "SC-C3-03": {
      ...
      lines: [
        ...
        stage("広告ビジョンが1カットだけ、見慣れない絵柄に化けて、次カットで元に戻る"),
    ...
    "SC-C3-09": {
      ...
      variants: {
        bad: {
          ...
          body: "rc地区が拡張を開始。入区申請カウンタが回り出し、賛同者の歓呼が音として満ちる。\nリリース宣言が、祝祭として放送される。\nケイスケ「リリースノートは決めた。——『これで全員、自由だ』」\n歓声が、その宣言に重なる。\n——歓呼の中、ケイスケが初めて、贈られた椅子に座る。"
        },
        normal: {
          id: "SC-C3-09b", title: "二重に安全な街",
          body: "rcは強制停止、凍結は継続。世界は二重に安全で、二重に息苦しい。\n抗議の声は「記録済み」のスタンプだけが押されて閉じられていく。\nリコの裁量解除は、上層に却下される。リコは何も言わない。ただ、署名した一枚目を、引き出しにしまう。\n無人のラボ。リリースノートの編集画面に向かうケイスケ。\nケイスケ「リリースノートは決めた。——『これで全員、自由だ』」\n誰の歓声もない。玉座めいた椅子は、隅に置かれたまま。"
        },
        true: {
          id: "SC-C3-09c", title: "離脱ボタン",
          body: "rc停止と凍結の裁量解除が両立した状態で、撤退間際のケイスケとの対話が成立する。\nレントン「回復ってな、行きっぱなしやなくて、行って、帰ってくることなんよ。……あの地区には、『帰る』が見つからんかった」\nケイスケ、答えに詰まる。視線が一度だけ稼働データの方向へ流れて、戻る。\nリコ「その新世界、離脱ボタンは付けた?」\nケイスケ、即答できない。間。\nケイスケ「……次のビルドまでに、考えとく」\n転落の入口で、足が一瞬止まる音。ケイスケ、ロボの肩に飛び乗って撤退。\n撤退後、遠景の通信越しに、リリース宣言だけが届く。\nケイスケ「リリースノートは決めた。——『これで全員、自由だ』」\n迷いが流れたまま、それでも宣言する。半歩止まったが、止まってはいない。"
        }
      }
    },
    "SC-C3-10": {
    ...
    "SC-C4-01": {
      ...
      lines: [
        stage("夜。ラボ。中央モニタに「AUTONOMY Ver.1.0 — 最終同期 準備完了」。世界地図の上を、統一の進捗バーが薄く走っている"),
        carry("ed_c3", "bad", "最終同期はすでに大きく進行している。拡張済みのrcが、そのまま同期の土台になっている"),
        carry("ed_c3", "normal", "無人のラボ。ケイスケは、誰もいないところから最終同期を始める"),
        ...
        line("ケイスケ", "雑なコピーが出るのは、ルールがバラバラだからだ。ぜんぶ俺のルールで統一すれば、二度と出ない。……論理は、通ってる", "keisuke", "serious"),
    ...
    "SC-C4-08": {
      ...
      prelude: "世界のUIが、一斉に切り替わる。——その一瞬、統一された画面のうち一つだけが、まるで別の作品のような絵柄に化けて、次のカットで元に戻る。誰も気づかない。",
      variants: {
        bad: {
          id: "SC-C4-08a", title: "自由の暴走",
          body: "最終同期が完了し、Ver.1.0 が世界OSとして走り出す。世界中のUIが、一つの規格に塗り替わっていく。\nケイスケは新世界の管理者の椅子に座っている。\n空欄だった最終行に、ケイスケが一人で書き切る。誰の連名もない。\nケイスケ「リリースノートは決めた。——『これで全員、自由だ』」\nその宣言は、誰にも届かないまま書き切られる。\n——完璧に最適化された、誰もいないラボ。返信のない三万件の通知を眺めるケイスケ。\nケイスケ「見てるか、みんな。……返信は、しないけどな」\n通知の数字だけが、静かに増えていく。祝祭も、歓声もない。\nケイスケ「……全員、自由にした。飲みに行く相手は、いないけどな」\n世界を手に入れた夜も、手元ガジェットの充電残量を一度だけ気にする。",
          releaseNote: "これで全員、自由だ", signature: "GADGET"
        },
        normal: {
          id: "SC-C4-08b", title: "秩序だけの勝利",
          body: "RAML が Ver.1.0 を完全停止。デプロイ画面がキャンセルされ、世界のUIが一斉に停止する。世界は安全に戻り、革新は起きない。\n最終行は誰にも書かれずに閉じる。署名欄も空欄のまま。\nGADGET は沈黙し、ケイスケは行方不明。安全で、変化がなく、少しだけ息苦しい日々。\nケイスケ（声だけ）「……止めれば、安全か。安全なだけの世界、そんなにいいもんかね」\n市民「事件は、なくなりました。……変わることも、なくなりましたけど」\n——リコの端末に、二度と着信が来ない。拒否する相手すら、いなくなった。リコは何も言わない。",
          releaseNote: "", signature: ""
        },
        true: {
          id: "SC-C4-08c", title: "自由と秩序の握手",
          body: "ケイスケ自身の手で Ver.1.0 に「審判」と「離脱ボタン」が実装される。AIに使われる側でも、AIで支配する側でもなく、AIを使いこなす側として両者が並ぶ。\n——中枢を貫ける拳を、寸前で開いて掌にした。その掌が、握手の場に開いたまま残っている。\n——審判の考え方を、勝ち負けではなく、あの人のルールに実装する提案として渡した。\nレントン「（内心）……この手、工具のタコやな。充電ケーブルの痕も。ずっと、なんか作りよった手や」\n最初に手を出すのは、レントン。\nレントン「行って、帰ってくる。……それが、握手なんよ、たぶん」\n握手のあと、レントンが自分の手を一度握って、開く。\nリコ「リリースノートの最終行、連名にする。止めることと、実装すること。両方の責任、うちも半分持つ。——GADGET と、RAML で」\n空欄が、初めて連名で埋まる。\nケイスケ、書き終わった最終行を一度見て、目を逸らす。照れている。\nケイスケ「Ver.2.0は、一緒に考えない?」",
